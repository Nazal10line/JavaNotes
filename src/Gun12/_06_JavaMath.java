...
public class _06_JavaMath {
    public static void main(String[] args) {
        ...
        System.out.println("ceil 3.1 = " + Math.ceil(4.1)); // bu rakamdan büyük en yakın tam sayı 5
        System.out.println("ceil 3.5 = " + Math.ceil(4.5)); // bu rakamdan büyük en yakın tam sayı 5
        System.out.println("floor 3.1 = " + Math.floor(5.1)); // bu rakamdan küçük en yakın tam sayı 5
        System.out.println("floor 3.5 = " + Math.floor(5.5)); // bu rakamdan küçük en yakın tam sayı 5
    }
}
